...
<meta content="util/OBJLoader.js · master · jwflory / Water Simulation" property="og:title">
...
<meta content="https://git.linux.iastate.edu/jwflory/water-simulation/blob/master/util/OBJLoader.js" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="util/OBJLoader.js · master · jwflory / Water Simulation" property="twitter:title">
...
<title>util/OBJLoader.js · master · jwflory / Water Simulation · GitLab</title>
...
<meta name="csrf-token" content="IrWIKFXx13VzO9Na+OyjGicPzD3oaZ6Ih04+O1+wECAPwdkOEq1v5AGoa7sYq+4kf2pMSNnVBnDbLsvt/vAUig==" />
...
<li>
<h2 class="breadcrumbs-sub-title"><a href="/jwflory/water-simulation/blob/master/util/OBJLoader.js">Repository</a></h2>
</li>
</ul>
</div>
...
<div class="js-signature-container" data-signatures-path="/jwflory/water-simulation/commits/12f741f56ab7cd40b94e5627df368be99e7aab75/signatures"></div>
...
<input type="hidden" name="path" id="path" value="util/OBJLoader.js" />
<div class="dropdown">
...
<li class="breadcrumb-item">
<a href="/jwflory/water-simulation/blob/master/util/OBJLoader.js"><strong>OBJLoader.js</strong>
</a></li>
</ul>
</div>
...
<div class="btn-group" role="group"><a class="btn js-blob-blame-link" href="/jwflory/water-simulation/blame/master/util/OBJLoader.js">Blame</a><a class="btn" href="/jwflory/water-simulation/commits/master/util/OBJLoader.js">History</a><a class="btn js-data-file-blob-permalink-url" href="/jwflory/water-simulation/blob/cb6d689cfa15573a644021a3eab37ec502b474ae/util/OBJLoader.js">Permalink</a></div>
</div>
</div>
...
<li class="commit flex-row js-toggle-container" id="commit-12f741f5">
...
<a class="commit-row-message item-title js-onboarding-commit-item" href="/jwflory/water-simulation/commit/12f741f56ab7cd40b94e5627df368be99e7aab75">Added camera controls and basic skybox</a>
<span class="commit-row-message d-inline d-sm-none">
&middot;
12f741f5
</span>
<div class="committer">
<a class="commit-author-link" href="mailto:joshf98@aol.com">JoshFloorGuy</a> authored <time class="js-timeago" title="Dec 12, 2019 7:53pm" datetime="2019-12-13T01:53:26Z" data-toggle="tooltip" data-placement="bottom" data-container="body">Dec 13, 2019</time>
</div>

</div>
<div class="commit-actions flex-row">

<div class="js-commit-pipeline-status" data-endpoint="/jwflory/water-simulation/commit/12f741f56ab7cd40b94e5627df368be99e7aab75/pipelines?ref=master"></div>
<div class="commit-sha-group d-none d-sm-flex">
<div class="label label-monospace monospace">
12f741f5
</div>
<button class="btn btn btn-default" data-toggle="tooltip" data-placement="bottom" data-container="body" data-title="Copy commit SHA to clipboard" data-class="btn btn-default" data-clipboard-text="12f741f56ab7cd40b94e5627df368be99e7aab75" type="button" title="Copy commit SHA to clipboard" aria-label="Copy commit SHA to clipboard"><svg><use xlink:href="/assets/icons-351e10820d76c3052c94570c89d3c67936a2915b1cc0b9c99b63885be7ff1961.svg#duplicate"></use></svg></button>
...
<button class="btn btn-clipboard btn-transparent" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn-clipboard btn-transparent" data-title="Copy file path to clipboard" data-clipboard-text="{&quot;text&quot;:&quot;util/OBJLoader.js&quot;,&quot;gfm&quot;:&quot;`util/OBJLoader.js`&quot;}" type="button" title="Copy file path to clipboard" aria-label="Copy file path to clipboard"><svg><use xlink:href="/assets/icons-351e10820d76c3052c94570c89d3c67936a2915b1cc0b9c99b63885be7ff1961.svg#duplicate"></use></svg></button>
<small class="mr-1">
18.6 KB
</small>
</div>
...
<div class="btn-group" role="group"><button class="btn btn btn-sm js-copy-blob-source-btn" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn btn-sm js-copy-blob-source-btn" data-title="Copy source to clipboard" data-clipboard-target=".blob-content[data-blob-id=&#39;8e2ae4c53b622d8452c71eb2daaf801ce03bbbb2&#39;]" type="button" title="Copy source to clipboard" aria-label="Copy source to clipboard"><svg><use xlink:href="/assets/icons-351e10820d76c3052c94570c89d3c67936a2915b1cc0b9c99b63885be7ff1961.svg#duplicate"></use></svg></button><a class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" title="Open raw" data-container="body" href="/jwflory/water-simulation/raw/master/util/OBJLoader.js"><i aria-hidden="true" data-hidden="true" class="fa fa-file-code-o"></i></a><a download="util/OBJLoader.js" class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" title="Download" data-container="body" href="/jwflory/water-simulation/raw/master/util/OBJLoader.js?inline=false"><svg><use xlink:href="/assets/icons-351e10820d76c3052c94570c89d3c67936a2915b1cc0b9c99b63885be7ff1961.svg#download"></use></svg></a></div>
<div class="btn-group" role="group"><a class="btn js-edit-blob  btn-sm" href="/jwflory/water-simulation/edit/master/util/OBJLoader.js">Edit</a><a class="btn btn-default btn-sm" href="/-/ide/project/jwflory/water-simulation/edit/master/-/util/OBJLoader.js">Web IDE</a><button name="button" type="submit" class="btn btn-default" data-target="#modal-upload-blob" data-toggle="modal">Replace</button><button name="button" type="submit" class="btn btn-remove" data-target="#modal-remove-blob" data-toggle="modal">Delete</button></div>
</div>
</div>
...
<a class="js-fork-suggestion-button btn btn-grouped btn-inverted btn-success" rel="nofollow" data-method="post" href="/jwflory/water-simulation/blob/master/util/OBJLoader.js">Fork</a>
...
<div class="blob-viewer" data-type="simple" data-url="/jwflory/water-simulation/blob/master/util/OBJLoader.js?format=json&amp;viewer=simple">
...
<h3 class="page-title">Delete OBJLoader.js</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden="true">&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-delete-blob-form js-quick-submit js-requires-input" action="/jwflory/water-simulation/blob/master/util/OBJLoader.js" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="delete" /><input type="hidden" name="authenticity_token" value="4oxiWWlUQNhIwkN//2M8gXB+uYnYtpfth9p09B4TnG7P+DN/Lgj4STpR+54fJHG/KBs5/OkKDxXbuoEiv1OYxA==" /><div class="form-group row commit_message-group">
<label class="col-form-label col-sm-2" for="commit_message-95cf99997c6deea07444bf2b02dd17ba">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-95cf99997c6deea07444bf2b02dd17ba" class="form-control js-commit-message" placeholder="Delete OBJLoader.js" required="required" rows="3">
Delete OBJLoader.js</textarea>
</div>
</div>
</div>
...
<input type="checkbox" name="create_merge_request" id="create_merge_request-2467edba930551e400150323bf7109dc" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-2467edba930551e400150323bf7109dc">Start a <strong>new merge request</strong> with these changes
</label></div>
...
<div class="modal-content">
<div class="modal-header">
<h3 class="page-title">Replace OBJLoader.js</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden="true">&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form" data-method="put" action="/jwflory/water-simulation/update/master/util/OBJLoader.js" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="aWfYl8PvfusFGcZdqRYCJ07GYbKX+t9CmmtBYYLiXNZEE4mxhLPGeneKfrxJUU8ZFqPhx6ZGR7rGC7S3I6JYfA==" /><div class="dropzone">
...
<label class="col-form-label col-sm-2" for="commit_message-4b38ada7f2da6468d1a66ba55dbd983d">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-4b38ada7f2da6468d1a66ba55dbd983d" class="form-control js-commit-message" placeholder="Replace OBJLoader.js" required="required" rows="3">
Replace OBJLoader.js</textarea>
</div>
</div>
</div>
...
<div class="js-create-merge-request-container">
<div class="form-check prepend-top-8">
<input type="checkbox" name="create_merge_request" id="create_merge_request-2f070f93ce0430ac8682916f05370d76" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-2f070f93ce0430ac8682916f05370d76">Start a <strong>new merge request</strong> with these changes
</label></div>
