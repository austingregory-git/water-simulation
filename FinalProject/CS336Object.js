...
<meta content="util/CS336Object.js · master · jwflory / Water Simulation" property="og:title">
...
<meta content="https://git.linux.iastate.edu/jwflory/water-simulation/blob/master/util/CS336Object.js" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="util/CS336Object.js · master · jwflory / Water Simulation" property="twitter:title">
...
<title>util/CS336Object.js · master · jwflory / Water Simulation · GitLab</title>
...
<meta name="csrf-token" content="eRnQfDdB+816zLpD8L0LHVhjiDjlJzel+5Tscu3GUWBUbYFacB1DXAhfAqIQ+kYjAAYITdSbr12n9BmkTIZVyg==" />
...
<li>
<h2 class="breadcrumbs-sub-title"><a href="/jwflory/water-simulation/blob/master/util/CS336Object.js">Repository</a></h2>
</li>
</ul>
</div>
...
<input type="hidden" name="path" id="path" value="util/CS336Object.js" />
<div class="dropdown">
...
<li class="breadcrumb-item">
<a href="/jwflory/water-simulation/blob/master/util/CS336Object.js"><strong>CS336Object.js</strong>
</a></li>
</ul>
</div>
...
<div class="btn-group" role="group"><a class="btn js-blob-blame-link" href="/jwflory/water-simulation/blame/master/util/CS336Object.js">Blame</a><a class="btn" href="/jwflory/water-simulation/commits/master/util/CS336Object.js">History</a><a class="btn js-data-file-blob-permalink-url" href="/jwflory/water-simulation/blob/cb6d689cfa15573a644021a3eab37ec502b474ae/util/CS336Object.js">Permalink</a></div>
</div>
</div>
...
<button class="btn btn-clipboard btn-transparent" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn-clipboard btn-transparent" data-title="Copy file path to clipboard" data-clipboard-text="{&quot;text&quot;:&quot;util/CS336Object.js&quot;,&quot;gfm&quot;:&quot;`util/CS336Object.js`&quot;}" type="button" title="Copy file path to clipboard" aria-label="Copy file path to clipboard"><svg><use xlink:href="/assets/icons-351e10820d76c3052c94570c89d3c67936a2915b1cc0b9c99b63885be7ff1961.svg#duplicate"></use></svg></button>
<small class="mr-1">
9.08 KB
</small>
</div>
...
<div class="btn-group" role="group"><button class="btn btn btn-sm js-copy-blob-source-btn" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn btn-sm js-copy-blob-source-btn" data-title="Copy source to clipboard" data-clipboard-target=".blob-content[data-blob-id=&#39;aac86f0ec41c4dbfa559d1b238de4a25f6a07ed3&#39;]" type="button" title="Copy source to clipboard" aria-label="Copy source to clipboard"><svg><use xlink:href="/assets/icons-351e10820d76c3052c94570c89d3c67936a2915b1cc0b9c99b63885be7ff1961.svg#duplicate"></use></svg></button><a class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" title="Open raw" data-container="body" href="/jwflory/water-simulation/raw/master/util/CS336Object.js"><i aria-hidden="true" data-hidden="true" class="fa fa-file-code-o"></i></a><a download="util/CS336Object.js" class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" title="Download" data-container="body" href="/jwflory/water-simulation/raw/master/util/CS336Object.js?inline=false"><svg><use xlink:href="/assets/icons-351e10820d76c3052c94570c89d3c67936a2915b1cc0b9c99b63885be7ff1961.svg#download"></use></svg></a></div>
<div class="btn-group" role="group"><a class="btn js-edit-blob  btn-sm" href="/jwflory/water-simulation/edit/master/util/CS336Object.js">Edit</a><a class="btn btn-default btn-sm" href="/-/ide/project/jwflory/water-simulation/edit/master/-/util/CS336Object.js">Web IDE</a><button name="button" type="submit" class="btn btn-default" data-target="#modal-upload-blob" data-toggle="modal">Replace</button><button name="button" type="submit" class="btn btn-remove" data-target="#modal-remove-blob" data-toggle="modal">Delete</button></div>
</div>
</div>
...
<a class="js-fork-suggestion-button btn btn-grouped btn-inverted btn-success" rel="nofollow" data-method="post" href="/jwflory/water-simulation/blob/master/util/CS336Object.js">Fork</a>
...
<div class="blob-viewer" data-type="simple" data-url="/jwflory/water-simulation/blob/master/util/CS336Object.js?format=json&amp;viewer=simple">
...
<h3 class="page-title">Delete CS336Object.js</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden="true">&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-delete-blob-form js-quick-submit js-requires-input" action="/jwflory/water-simulation/blob/master/util/CS336Object.js" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="delete" /><input type="hidden" name="authenticity_token" value="Ux0HNIswkZwubs5C4z8qBZOCyvSZXZuandzFPvBulRN+aVYSzGwpDVz9dqMDeGc7y+dKgajhA2LBvDDoUS6RuQ==" /><div class="form-group row commit_message-group">
<label class="col-form-label col-sm-2" for="commit_message-fd36c19fe986bb77b7d176e4ce7cec12">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-fd36c19fe986bb77b7d176e4ce7cec12" class="form-control js-commit-message" placeholder="Delete CS336Object.js" required="required" rows="3">
Delete CS336Object.js</textarea>
</div>
</div>
</div>
...
<input type="checkbox" name="create_merge_request" id="create_merge_request-9498f29df19dfd3d7814680267c893a3" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-9498f29df19dfd3d7814680267c893a3">Start a <strong>new merge request</strong> with these changes
</label></div>
...
<div class="modal-content">
<div class="modal-header">
<h3 class="page-title">Replace CS336Object.js</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden="true">&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form" data-method="put" action="/jwflory/water-simulation/update/master/util/CS336Object.js" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="f+UxGSpgDm1enVZpdlvfytUyZi9TLKFVKwHsBXiY7spSkWA/bTy2/CwO7oiWHJL0jVfmWmKQOa13YRnT2djqYA==" /><div class="dropzone">
...
<label class="col-form-label col-sm-2" for="commit_message-3780c1c209f1b2e1875e6238c6669f3b">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-3780c1c209f1b2e1875e6238c6669f3b" class="form-control js-commit-message" placeholder="Replace CS336Object.js" required="required" rows="3">
Replace CS336Object.js</textarea>
</div>
</div>
</div>
...
<div class="js-create-merge-request-container">
<div class="form-check prepend-top-8">
<input type="checkbox" name="create_merge_request" id="create_merge_request-0aef1c044eaeed28c761f8dc4dcb247d" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-0aef1c044eaeed28c761f8dc4dcb247d">Start a <strong>new merge request</strong> with these changes
</label></div>
